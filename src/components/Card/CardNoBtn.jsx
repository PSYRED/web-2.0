...
function CardNoBtn({title,content,icon,color}) {
   ...
   return (
    <div className={`group    p-5 md:w-[70rem] border-1  ${borderColor} rounded-lg    mt-3 transition-all duration-100 flex flex-col items-center space-y-4 `}>
          <div className="bg-red-800 group-hover:bg-white group-hover:border-4 group-hover:border-red-700  w-24 h-24 rounded-full flex items-center justify-center mt-6  ml-auto mr-auto ">
             {icon}  
          </div>
